...
size_t steering_start = epsi_start + N;
size_t throttle_start = steering_start + N - 1;
 ...
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
      ...
      for (unsigned int t = 1; t < N; t++) {
        ...
        AD<double> delta0 = vars[steering_start + t - 1];
        AD<double> a0 = vars[throttle_start + t - 1];
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
  ...
  result.push_back(solution.x[steering_start]);
